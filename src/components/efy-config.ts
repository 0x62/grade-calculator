  ...
  },
  {
    ...
    assessments: [
      ...
      },
      {
        ...
        subtasks: [
          { id: "rts-b1-task-1", name: "Task 1", weight: 6, totalMarks: 100 },
          { id: "rts-b1-task-2", name: "Task 2", weight: 6, totalMarks: 100 },
          { id: "rts-b1-task-3", name: "Task 3", weight: 6, totalMarks: 100 },
          { id: "rts-b1-task-4", name: "Task 4", weight: 6, totalMarks: 100 },
          { id: "rts-b1-task-5", name: "Task 5", weight: 6, totalMarks: 100 },
        ],
      },
      {
